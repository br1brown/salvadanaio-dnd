	...
	<div class="offset-1 col-10 offset-md-2 col-md-8 shadow rounded tutto text-center">
		...
		<div class="row">
			...
			<div class="col-xs-8 col-sm-8 col-md-8">
				...
				<input type="button" class="bottone btn btn-primary btn-lg"
