...
<div class="container-fluid">
	<div class="row">
		<div class="col-12 offset-md-1 col-md-10 text-center tutto">
			...
			<hr>
			<?php if (isset($social)): ?>
				<a href=<?= $social['telegram'] ?> target=_blank title="Telegram"><i
						class="social-icon fab fa-telegram"></i></a>
				<a href=<?= $social['whatsapp'] ?> target=_blank title="Whatsapp"><i
				...
				<a href=<?= $social['pinterest'] ?> target=_blank title="Pinterest"><i
						class="social-icon fab fa-pinterest"></i></a>
				<a href=<?= $social['snapchat'] ?> target=_blank title="Snapchat"><i
						class="social-icon fab fa-snapchat"></i></a>
				...
				<a href=<?= $social['foursquare'] ?> target=_blank title="Foursquare"><i
						class="social-icon fab fa-foursquare"></i></a>
				<hr>
				<a href=<?= $social['youtube'] ?> target=_blank title="Youtube"><i
						class="social-icon fab fa-youtube"></i></a>
				<a href=<?= $social['twitch'] ?> target=_blank title="Twitch"><i class="social-icon fab fa-twitch"></i></a>
				<a href=<?= $social['spotify'] ?> target=_blank title="Spotify"><i
						class="social-icon fab fa-spotify"></i></a>
				<a href=<?= $social['deezer'] ?> target=_blank title="Deezer"><i class="social-icon fab fa-deezer"></i></a>
				<a href=<?= $social['soundcloud'] ?> target=_blank title="Soundcloud"><i
						class="social-icon fab fa-soundcloud"></i></a>
				...
				<a href=<?= $social['dribbble'] ?> target=_blank title="Dribbble"><i
						class="social-icon fab fa-dribbble"></i></a>
				<a href=<?= $social['yahoo'] ?> target=_blank title="Yahoo"><i class="social-icon fab fa-yahoo"></i></a>
				<a href=<?= $social['audible'] ?> target=_blank title="Audible"><i
						class="social-icon fab fa-audible"></i></a>

				<hr>
				<a href=<?= $social['google'] ?> target=_blank title="Google"><i class="social-icon fab fa-google"></i></a>
				<a href=<?= $social['chromecast'] ?> target=_blank title="Chromecast"><i
						class="social-icon fab fa-chromecast"></i></a>
				<a href=<?= $social['chrome'] ?> target=_blank title="Chrome"><i class="social-icon fab fa-chrome"></i></a>
				<a href=<?= $social['android'] ?> target=_blank title="Android"><i
						class="social-icon fab fa-android"></i></a>
				<a href=<?= $social['apple'] ?> target=_blank title="Apple"><i class="social-icon fab fa-apple"></i></a>
				<a href=<?= $social['playstation'] ?> target=_blank title="Playstation"><i
						class="social-icon fab fa-playstation"></i></a>
