...
<div class="input-group mb-2">
  <textarea id="note" onkeypress="onkeypress()" maxlength="50" name="note" class="form-control txtawMax" rows="1" placeholder="Note (opzionale)" style="resize: none;"><?php echo htmlspecialchars(str_replace(" - ","\n",$note)); ?></textarea>
